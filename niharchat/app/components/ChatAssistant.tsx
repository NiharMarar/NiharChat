...
export default function ChatAssistant() {
  ...
  return (
    <div className="flex flex-col h-full bg-[#343541]">
      ...
      <div className="border-t border-[#565869] p-3 lg:p-4">
        {/* Top Row Icons - Hidden on mobile to save space */}
        <div className="hidden sm:flex justify-center space-x-4 mb-2">
        ...
        <form onSubmit={handleSend} className="relative">
          <div className="relative">
            <input
              ...
              className="w-full bg-[#40414f] text-white placeholder-gray-400 rounded-xl px-3 lg:px-4 py-2.5 lg:py-3 pr-12 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none text-sm lg:text-base"
              disabled={loading}
            />
        ...
        {/* Bottom Row Controls - Hidden on mobile to save space */}
